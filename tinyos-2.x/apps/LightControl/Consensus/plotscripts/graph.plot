...
set title "Estimate for optimal output intensity of light 0"

set output "light_0_time.eps"
...
set xlabel "Time[s]"
set ylabel "Estimate of optimizer"
set title "Estimate for optimal output intensity of light 1"

set output "light_1_time.eps"

plot "estimate_1.dat" index 0 u 1:3 notitle with lines ls 1, \
    "" index 1 u 1:3 notitle with lines ls 2, \
    "" index 2 u 1:3 notitle with lines ls 3, \
    "" index 3 u 1:3 notitle with lines ls 3, \
    "" index 4 u 1:3 notitle with lines ls 3, \
...
set xlabel "Time[s]"
set ylabel "Estimate of optimizer"
set title "Estimate for optimal output intensity of light 2"

set output "light_2_time.eps"

plot "estimate_2.dat" index 0 u 1:3 notitle with lines ls 1, \
    "" index 1 u 1:3 notitle with lines ls 2, \
    "" index 2 u 1:3 notitle with lines ls 3, \
    "" index 3 u 1:3 notitle with lines ls 3, \
    "" index 4 u 1:3 notitle with lines ls 3, \
...
set xlabel "Time[s]"
set ylabel "Estimate of optimizer"
set title "Estimate for optimal output intensity of light 3"

set output "light_3_time.eps"

plot "estimate_3.dat" index 0 u 1:3 notitle with lines ls 1, \
    "" index 1 u 1:3 notitle with lines ls 2, \
    "" index 2 u 1:3 notitle with lines ls 3, \
    "" index 3 u 1:3 notitle with lines ls 3, \
    "" index 4 u 1:3 notitle with lines ls 3, \
...
set output "light_1_iter.eps"

plot "estimate_1.dat" index 0 u ($2/2):3 notitle with lines ls 1, \
    "" index 1 u ($2/2):3 notitle with lines ls 2, \
    "" index 2 u ($2/2):3 notitle with lines ls 3, \
    "" index 3 u ($2/2):3 notitle with lines ls 3, \
    "" index 4 u ($2/2):3 notitle with lines ls 3, \
...
set output "light_2_iter.eps"

plot "estimate_2.dat" index 0 u ($2/2):3 notitle with lines ls 1, \
    "" index 1 u ($2/2):3 notitle with lines ls 2, \
    "" index 2 u ($2/2):3 notitle with lines ls 3, \
    "" index 3 u ($2/2):3 notitle with lines ls 3, \
    "" index 4 u ($2/2):3 notitle with lines ls 3, \
...
set output "light_3_iter.eps"

plot "estimate_3.dat" index 0 u ($2/2):3 notitle with lines ls 1, \
    "" index 1 u ($2/2):3 notitle with lines ls 2, \
    "" index 2 u ($2/2):3 notitle with lines ls 3, \
    "" index 3 u ($2/2):3 notitle with lines ls 3, \
    "" index 4 u ($2/2):3 notitle with lines ls 3, \
